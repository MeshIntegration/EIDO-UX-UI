...
<head>
  ...
  <title>Patient Lookup - Survey - Scheduled</title>
...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <p class="name"><img src="../img/icons/page.png" alt="Page icon" class="page_icon float-left"/>HUGHES, Rob<br><span class="small">rob@hughes.com</span></p>
	  <p>&nbsp;</p>	
	  <h5>Activity</h5>
	  <p>This survey has not been sent yet</p>
	  <div class="grid-x">
		<div class="hide-for-small-only medium-1 cell"></div>		
	    <div class="small-12 medium-10 large-10 cell text-center">
	      <p>&nbsp;</p>
		  <p class="note text-left">The procedure must be complete before this survey can be sent.</p>
	      <button type="button" name="" value="Mark Procedure Complete" class="button large expanded" />Mark Procedure Complete</button>
	    </div>
		<div class="hide-for-small-only medium-1 cell"></div>		
	  </div>
	</div>
