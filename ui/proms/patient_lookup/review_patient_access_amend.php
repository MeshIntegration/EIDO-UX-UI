...
<head>
  ...
  <title>Patient Lookup - Review Patient Access - Amend</title>
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <table class="review stack">
	    <tr>
		  <td class="aqua_bdr no_left_pad grey_bdr text-right" width="27%">Patient Entry</td>
		...
		<tr>
		  <td colspan="2" class="no_left_pad">
            <input type="text" name="" placeholder="DOB: 01-04-1985">
		  </td>
		</tr>
		<tr>
		  <td width="27%">&nbsp;</td>	
		  <td width="73%">
		    <div class="stacked-for-small button-group text-right">
  			  <button type="button" name="amend" value="Amend" class="button hollow inactive amend" />Amend</button>
  			  <button type="button" name="match" value="Match" class="button large inactive match" />Match</button>
			</div>
		  </td>
		</tr>
	  </table>
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 large-6 cell text-center">
	      <p>&nbsp;</p>
	      <button type="submit" name="" value="update patient" data-tooltip aria-haspopup="true" data-disable-hover="false" tabindex="1" title="Place text here" data-position="top" data-alignment="center" class="has-tip button large inactive expanded inactive" />update patient</button>
	    </div>
		<div class="hide-for-small-only medium-3 large-3 cell"></div>
	  </div>
	</div>
