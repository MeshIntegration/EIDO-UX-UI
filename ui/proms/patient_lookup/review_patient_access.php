...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Review Patient Access<br /><span class="small">The patient has attempted to sign in, but cannot match their data.  The most likely cause is a data entry error in Verify.  
		  Check the data the patient entered vs the data in your PAS system to see if there is a mis-match.</span></h5>
	  <p>&nbsp;</p>
	  <h5 class="ps_red">JONES, William<span class="small">Sign In Review</span></h5>
	  <h5>Surname</h5>
	  <table class="review stack">
	    <tr>
		  <td class="aqua_bdr grey_bdr text-right" width="27%">Patient Entry</td>
		  <td class="upper" width="73%">Jones</td>
		</tr>
		<tr class="space">
		  <td colspan="2">&nbsp;</td>
		</tr>
		<tr>
		  <td class="green_bdr grey_bdr text-right" width="27%">Verify Entry</td>
		  <td class="upper" width="73%">Jones</td>
		</tr>
		<tr>
		  <td width="27%">&nbsp;</td>	
		  <td width="73%">
		    <div class="stacked-for-small button-group text-right">
  			  <button type="button" name="amend" value="Amend" class="button inactive amend" />Amend</button></button>
  			  <button type="button" name="match" value="Match" class="button large match" />Match
			</div>
		  </td>
		</tr>
	  </table>
	  ...
	  <table class="review stack">
	    <tr>
		  <td class="aqua_bdr grey_bdr text-right" width="30%">Patient Entry</td>
		  <td class="upper" width="70%">NG12 5HP</td>
		</tr>
		<tr class="space">
		  <td colspan="2">&nbsp;</td>
		</tr>
		<tr>
		  <td class="green_bdr grey_bdr text-right" width="27%">Verify Entry</td>
		  <td class="upper" width="73%">NG12 5HP</td>
		</tr>
		<tr>
		  <td width="27%">&nbsp;</td>	
		  <td width="73%">
		    <div class="stacked-for-small button-group text-right">
  			  <button type="button" name="amend" value="Amend" class="button inactive amend" />Amend</button>
  			  <button type="button" class="button match hollow postfix" name="match" value="Match">Match</button>
			     Match&nbsp;&nbsp;<i class="fi-checkbox"></i>
			  </button>
			</div>
		  </td>
		</tr>
	  ...
	  <table class="review stack">
	    <tr>
		  <td class="aqua_bdr grey_bdr text-right" width="27%">Patient Entry</td>
		  <td class="upper" width="73%">01-04-1985</td>
		</tr>
		<tr class="space">
		  <td colspan="2">&nbsp;</td>
		</tr>
	  ...
	  <table class="review stack">
	    <tr>
		  <td class="aqua_bdr grey_bdr text-right" width="27%">Patient Entry</td>
		  <td class="upper" width="73%">987 654 321</td>
		</tr>
		<tr class="space">
		  <td colspan="2">&nbsp;</td>
		</tr>
