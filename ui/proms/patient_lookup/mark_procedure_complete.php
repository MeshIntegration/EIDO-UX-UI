...
<head>
  ...
  <title>Patient Lookup - Mark Procedure Complete</title>
...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Mark Procedure Complete<br /><span class="small">Confirm that the procedure has been completed and who by</span></h5>
	  <p>&nbsp;</p>
	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-8 large-8 cell text-center">
	      <p>&nbsp;</p>
	      <button type="button" name="" value="confirm complete" class="button large expanded" />confirm complete</button>
	    </div>
		<div class="hide-for-small-only medium-2 large-2 cell"></div>
	  </div>
	</div>
