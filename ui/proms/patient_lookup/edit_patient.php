...
<head>
  ...
  <title>Patient Lookup - Edit Patient</title>
    	  ...
    	  <div class="grid-x grid-padding-x">
			...
			<div class="small-12 medium-12 large-12 cell">
			  ...
			  <div class="grid grid-x">
				...
				<div class="hide-for-small-only medium-8"><button type="submit" name="" class="button expanded inactive">Edit Address</button></div>
				<div class="hide-for-small-only medium-2">&nbsp;</div>
			  </div>
            </div>
			<div class="small-12 medium-12 large-12 cell">
