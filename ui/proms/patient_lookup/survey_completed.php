...
<head>
  ...
  <title>Patient Lookup - Survey - Completed</title>
...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5><img src="../img/icons/page.png" alt="Page icon" class="page_icon float-left align-middle"/>UR07 - Quality of Life<br><span class="small">11-05-2017&nbsp;&nbsp;&nbsp;12:34pm</span></h5>
	  <p>&nbsp;</p>	
	  <h5>Patient Score: 36/100</h5>
	  <p>A score of 25 - 50 indicates the patient has some ongoing health isses. View the PDF report for a full update.</p>
	  <h6 class="border">Tags</h6>
	  <p>The following tags were derived from this survey response.</p>
	  <p><span class="label tag">Diabetic</span></p>
	  <div class="small-12 medium-12 large-12 cell text-center">
	    <a href="#" class="no-u"><p class="directive"><img src="../img/pdf.png" alt="greater than icon" class="page_icon float-left align-middle" />View Patient Response<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle" /></p></a>
      </div>
	</div>
	<!-- End Content-Right --> 
  </div>
