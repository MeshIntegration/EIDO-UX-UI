...
<head>
  ...
  <title>Patient Lookup - Cancel Procedure</title>
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <div class="small-12 medium-12 large-12 cell text-center">
	    <a href="#" class="no-u"><p class="directive">Change Procedure Date<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle" /></p></a>
      </div>
	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-8 large-8 cell text-center">
	      <p>&nbsp;</p>
		  <button type="button" name="" value="Procedure Complete" class="button large expanded" />Procedure Complete</button>
	    </div>
		<div class="hide-for-small-only medium-2 large-2 cell"></div>		
	  </div>
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-8 large-8 cell text-center">
					  ...
					  <div class="small-12 medium-12 large-12 cell text-center">
			            <div class="grid-x">
						  ...
						  <div class="small-12 medium-6"><br>
                  		    <button type="button" name="" value="No" class="button large expanded inactive" />No</button>
				            <button type="button" name="" value="Confirm Delete" class="button large expanded red" />Confirm Delete</button>
				          </div>
						  <div class="hide-for-small-only medium-3">&nbsp;</div>
			            </div>
			            <p>&nbsp;</p>
		  ...
		  <p><button class="button large expanded red" name="" data-open="exampleModal1">Cancel Procedure</button></p>
	    </div>
		<div class="hide-for-small-only medium-2 large-2 cell"></div>		
	  </div>
	</div>
