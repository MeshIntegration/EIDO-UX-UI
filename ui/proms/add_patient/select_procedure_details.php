...
<head>
  ...
  <title>Add Patient - Select Procedure - Selection Details</title>
...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Select Procedure<br /><span class="small">Which procedure will the patient have?</span></h5>
	  <p>&nbsp;</p>
      <ul class="no-bullet process">
	    <li><img src="../img/icons/arrow.png" alt="completed"/>PRE - Medical History</li>
		<li><img src="../img/icons/arrow.png" alt="completed"/>PRE - Core UG08 Information &amp; Questions</li>
		<li><img src="../img/icons/caution.png" alt="attention needed"/><strong>Procedure</strong></li>
		<li><img src="../img/icons/arrow.png" alt="completed"/>Post Op Follow Up</li>
	  </ul>  
	  <p>&nbsp;</p>
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 large-6 cell text-center">
	      <p>&nbsp;</p>
	      <input type="button" name="" value="select" class="button large expanded" />
	    </div>
		<div class="hide-for-small-only medium-3 large-3 cell"></div>
	  </div>
	</div>
