...
<head>
  ...
  <title>Add Patient - Select Procedure</title>
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <form>
    	  ...
    	  <div class="grid-x grid-padding-x">
        	  ...
        	  <label>Procedure
                <input type="text" name="" placeholder="Search by name or code">
              </label>
            </div>
		  </div>
		</div>
	  ...
	  <p></p>
	  <h6 class="border">Recent Procedures</h6>
	  <table class="table_list">
	    <tr>
		  <td>UR06 - Rigid Cystoscopy (male)</td>
		</tr>
		<tr>
		  <td>UR07 - Flexible Cystoscopy (male)</td>
		</tr>
		<tr>
		  <td>UG08 - Open Cholecystectom</td>
		</tr>
		<tr>
		  <td>UG07 - Laparoscopic Cholecystectomy</td>
		</tr>
	  </table>
	  <p>&nbsp;</p>
	  <div class="grid-x">
