...
<head>
  ...
  <title>Add Patient - Confirmation</title>
	  ...
	  <div class="grid-x text-center">
		...
		<div class="small-12 medium-6 large-6 cell">
		  ...
		  <div class="grid-x grid-padding-x">
		    ...
		    <div class="small-12 medium-12 large-12 cell text-center">
		      <p>&nbsp;</p>
			  <input type="button" name="" value="ADD ANOTHER" class="button large expanded" />
			  <input type="button" name="" value="Home" class="button large expanded inactive" />
		    </div>
          </div>
		</div>
	    <div class="hide-for-small-only medium-3 large-3 cell"></div>
