...
<head>
  ...
  <title>Add Patient - Address Lookup</title>
...
<div class="grid-container">
  ...
  <div class="grid-x padding-x">
    ...
    <div class="cell navigation-bar">
	  <ul class="menu simple show-for-medium">
		<li class="current"><a href="add_user.php">Users</a></li>
		<li><a href="add_organisation.php">Organisations</a></li>
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Confirm Address<br /><span class="small">Select the paitents address.</span></h5>
	  <p>&nbsp;</p>
	  <h6 class="border">Procedure</h6>
	  <p>UG08 - Open Cholecystectomy</p>
	  ...
	  <form>
    	  ...
    	  <div class="grid-x grid-padding-x">
        	  ...
        	  <label>Postcode
                <input type="text" name="" placeholder="NG12 5HP">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>GMC Number
				<select id="address_select">
				  <option>1 Crossdale Drive, Keyworth, Notts</option>
				  <option>2 Crossdale Drive, Keyworth, Notts</option>
				  <option>3 Crossdale Drive, Keyworth, Notts</option>
				  <option>4 Crossdale Drive, Keyworth, Notts</option>
				  <option>5 Crossdale Drive, Keyworth, Notts</option>
			      <option>6 Crossdale Drive, Keyworth, Notts</option>
				  <option>7 Crossdale Drive, Keyworth, Notts</option>
				</select>
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>Address 1
                <input type="text" name="" placeholder="3 Crossdale Drive">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>Address 2
			...
			<div class="small-12 medium-12 large-12 cell">
        	  <label>Town
                <input type="text" name="" placeholder="Keyworth">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>County
                <input type="text" name="" placeholder="Notts">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>Postcode
	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 large-6 cell text-center">
	      <p>&nbsp;</p>
	      <input type="button" name="" value="confirm" class="button large expanded" />
	    </div>
		<div class="hide-for-small-only medium-3 large-3 cell"></div>
	  </div>
	</div>
