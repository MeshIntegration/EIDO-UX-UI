...
<head>
  ...
  <title>Add Patient - Which Surgeon</title>
...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Select Surgeon<br /><span class="small">Which surgeon will perform the procedure?</span></h5>
	  <p>&nbsp;</p>
	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 large-6 cell text-center">
	      <p>&nbsp;</p>
	      <input type="button" name="" value="next" class="button large expanded" />
	    </div>
		<div class="hide-for-small-only medium-3 large-3 cell"></div>
	  </div>
	</div>
