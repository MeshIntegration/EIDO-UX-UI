  ...
  <div class="grid-x grid-margin-x su">
    ...
    <div class="small-12 medium-6 large-6 cell content-left">
      <table width="90%" border="0"  class="su-table">
		  ...
		  <tr>
            <td width="10%"><input type="checkbox"></td>
			  <td width="80%"><p class="name"><span class="uc">HUGHES</span>, Rob<br /><span class="small">rob@hughes.com</span></p></td>
			<td width="10%"><img src="../img/icons/greater.png" alt="less than icon" class="float-right" /></td>
		  </tr>
		  <tr>
            <td width="10%"><input type="checkbox"></td>
			<td width="80%"><p class="name"><span class="uc">VILLANUEVA</span>, Dax<br /><span class="small">dax@relaxwithdax.com</span></p></td>
			<td width="10%"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></td>
		  </tr>	
		  <tr>
            <td width="10%"><input type="checkbox"></td>
			<td width="80%"><p class="name"><span class="uc">VASU</span>, William<br /><span class="small">bill@vasu.com</span></p></td>
			<td width="10%"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></td>
		  </tr>
		  <tr>
            <td width="10%"><input type="checkbox"></td>
			<td width="80%"><p class="name"><span class="uc">TUDOR</span>, Owain<br /><span class="small">owain@owain.com</span></p></td>
			<td width="10%"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></td>
		  </tr>
		  <tr>
		    <td colspan="3">
	  ...
	  <form>
    	  ...
    	  <div class="grid-x grid-padding-x">
			...
			<div class="small-12 medium-12 large-12 cell text-center">
        	  <input type="submit" name="" value="Add Users" class="button large" />
            </div>
    	  </div>
  		</div>
	  </form>
