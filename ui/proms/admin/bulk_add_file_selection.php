		...
		<div class="grid-x text-center">
		  ...
		  <div class="small-12 medium-6 large-6 cell">
		    ...
		    <div class="grid-x grid-padding-x">
			  <div class="small-12 medium-12 large-offset-4 cell text-center">
			    <div class="text-left">
				  <input id="checkbox1" type="checkbox"><label for="checkbox1" class="upscale">Add/Update Users</label><br />
                  <input id="checkbox2" type="checkbox"><label for="checkbox2" class="upscale">Delete Users</label>
				</div>
			  </div>
