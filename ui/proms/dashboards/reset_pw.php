		  ...
		  <form class="login">
			...
			<label>Password
			  <div class="input-group login">
                ...
                <input class="input-group-field" type="text" placeholder="Enter your password">
              </div>
			  <p>Enter PW Strength Here</p>
			</label>
			<div class="small-12 text-right cell"><p>&nbsp;</p></div>
			<div class="small-12 cell">
			  <button type="submit" name="" value="" class="button large float-right">Reset and Login</button>
			</div>
		  </form>
		    <div class="small-12 cell">
