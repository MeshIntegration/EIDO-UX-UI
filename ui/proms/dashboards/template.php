  ...
  <div class="grid-x grid-margin-x su">
    ...
    <div class="small-12 medium-6 large-6 cell content-left">
      <table width="90%" border="0" class="lookup">
          ...
          <tr>
		    <td colspan="3" class="top_bdr btm_bdr">
			  <div class="grid-x">
				...
				<div class="small-12 medium-6 large-6 cell text-right"><a href="#">SORT BY&nbsp;<i class="icon fi-plus fade-right"></i></a></div>  
			  </div>
			</td>
          </tr>
		  <tr>
          ...
          <tr>
			...
			<td><p class="name">HUGHES, Rob<br /><span class="small">rob@hughes.com</span></p></td>
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <div class="grid-x">
        ...
        <div class="small-12 medium-8 cell"><button class="button large expanded" href="#">Get Started</button></div>	  	
		<div class="hide-for-small-only medium-2 cell">&nbsp;</div>
	  </div>
	  <hr class="gap" />
	</div>
