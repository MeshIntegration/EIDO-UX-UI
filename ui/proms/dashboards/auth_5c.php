	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 align-center-middle cell">
		  ...
		  <form class="login">
			...
			<p>Please check your NHS number carefully.</p>
			<label class="alert">NHS Number
			  <div class="input-group login">
                <span class="input-group-label has-tip" data-tooltip aria-haspopup="true" data-disable-hover="false" tabindex="1" 
				  title="Please enter your NHS Number" data-position="top" data-alignment="left" id="tooltip_alert_day"><i class="fi-target alert"></i></span>
