		  ...
		  <form class="login">
			...
			<label>Postcode
			  <div class="input-group login">
                ...
                <input class="input-group-field" type="text" placeholder="Enter your postcode">
              </div>
			</label>
			<label>Address
			  <div class="input-group login">
                <span class="input-group-label"><i class="fi-marker"></i></span>
				<select class="input-group-field" placeholder="Select your postcode">
			...
			<div class="small-12 cell"><button type="submit" name="" value="" class="button large float-right">Login</button></div>
		  </form>
