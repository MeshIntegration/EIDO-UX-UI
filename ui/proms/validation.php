...
//Change the server URL for live vs. dev
            $URL = "http://eidoverify.com:8080/jw/web/json/workflow/process/list?packageId=".$packageId;
...
// echo "Session: $current_session<br />";
         ...
         $goto_url .= "&pid=" . $patientDetail['c_procedureId']."liv";
