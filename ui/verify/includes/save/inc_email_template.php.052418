                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td valign="top" class="mcnTextContent" style="color: #808080;font-family: Helvetica;font-size: 16px;line-height: 200%;text-align: center;">
                                                                                            ...
                                                                                            <p lang="x-size-12" style="text-align: center;"><span style="font-size:12px"><span style="font-family:lato,helvetica neue,helvetica,arial,sans-serif">The information you provide is sent back to the hospital, to help with diagnosis and treatment. For more information on how it works,&nbsp;<a href="http://www.eidoverify.com/about/" target="_blank">click here</a></span></span>
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
