         ...
         <div id="mobilecontainer" class="<?php echo $showmobile; ?>">
          ...
          <div id="emailcontainer" class="<?php echo $showemail; ?>">
			...
			<div id="contactdiv" class=" grid-x grid-padding-x">
  			  <div name="preferred" id="contactpreference" class="<?php echo $contactmethod; ?> small-12 cell">

                <span>Which contact method would you prefer?<br />
                    <input type="radio" readonly="readonly" disabled name="preferred" value="MOBILE" <?php echo $mobile_checked; ?> id="preferred_contact_mobile" ><label style="color: dimgrey !important;" for="preferred_contactBlue">Mobile</label>
                <input type="radio" name="preferred" value="EMAIL" <?php echo $email_checked; ?> id="preferred_contact_email"><label for="preferred_contactRed">E-mail</label>
				</span>
              </div>
			</div>
              <div id="contactdiv" class=" grid-x grid-padding-x">
              <div name="preferred" id="contactpreference" class="<?php echo $contactmethod; ?> small-12">
                  <span>Which contact method would you prefer?<br />
               <ul class="fancy-eido-round"><li>
                      <label class="fancy-eido-round-checkbox">
                          <input type="checkbox" name="preferred" value="EMAIL" <?php echo $email_checked; ?> id="preferred_contact_email" />
                          <span for="preferred_contactRed"><i class="icon eido-icon-dot-circle-o4 unchecked"></i>Email</span>
                      </label>
                  </li><li>
                      <label class="fancy-eido-round-checkbox">
                          <input type="checkbox"  name="preferred" value="MOBILE" <?php echo $mobile_checked; ?> id="preferred_contact_mobile" />
                          <span for="preferred_contactBlue">Mobile</span>
                      </label>
               </li><ul>
               </div>
              </div>
