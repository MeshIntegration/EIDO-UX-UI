	  ...
	  <div class="grid-x">
	    ...
	    <div class="small-12 medium-6 align-center-middle cell">
		  ...
		  <form class="login" action="validation_pw_a.php" method="post" id="form_container" >
			...
			<div class="grid-x">
			  <div class="small-12 cell alleft"><a href="validation_pw_a.php?skip=Y" name="skip" style="margin-bottom:0px;">Skip this step<br />I will enter my details again next time.</a></div>
			</div>
		  </form>
		    <div class="small-12 cell">
