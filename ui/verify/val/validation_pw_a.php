...
//may have came from contact
    ...
    save_pt_info($arr_pt_info['id'], $arr_pt_info['c_surname'], $arr_pt_info['c_postalCode'], $arr_pt_info['c_dateOfBirth'], $arr_pt_info['c_nhsNumber'], $password, $arr_pt_info['c_mobileNumber'], $arr_pt_info['c_preferredContactMethod'], $arr_pt_info['c_emailAddress'], $arr_pt_info['c_preferenceSet']);
