  ...
  <div class="grid-x su">
	...
	<!-- End Content-Left -->
        ...
        <?php } ?>
          ...
          <table class="su-table stack">
            <tr>
              <td colspan="5"><strong>Patient Timeline:</strong></td>
            </tr>
            <?php if (!$timeline) { ?>
            <tr>
              <td colspan="5">No Survey Activity</td>
            </tr>
            <?php } ?> 
...
logMsg("Desc: $tl_desc Date: $tl_date Type: $tl_type Image: $tl_imgfile Icon: $tl_iconfile Class: $tl_class",$logfile);
                  ?>                           
                  <tr>
                    <td class="icon_frame <?php echo $tl_class; ?>"><img src="../img/icons/<?php echo $tl_iconfile; ?>" alt="icon" class="align-middle"></td>
                    <td><img src="../img/icons/<?php echo $tl_imgfile; ?>" alt="Envelope icon"></td>
                    <td class="upper"><?php echo $tl_desc."<br />".$tl_link; ?></td>
                    <td><?php echo $tl_date; ?></td>
