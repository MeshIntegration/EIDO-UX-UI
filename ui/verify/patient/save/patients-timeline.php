...
<div class="small-12 medium-6 large-6 cell content-right <?php echo $overview_hide; ?>">
       ...
       <h5 class="<?php echo $pt_status_class; ?>"><?php echo "$c_surname, $c_firstName"; ?><span class="small"><?php echo $pt_status; ?></span></h5>
        ...
        <?php } ?>
         ...
         <div class="small-12 medium-12 large-12 cell content-right">
                <center><strong>Patient Timeline:</strong></center>
         </div>
              ...
              <?php for ($tl=0; $tl<count($arr_tl); $tl++)
                      { $tl_desc = trim($arr_tl[$tl]['c_timelineEntryDetail']);
                        ...
                        else if ($tl_type == "Event")
                        {
                           ...
                           $tl_iconfile = "check.png";
                        }
                        if ($tl_desc=="Procedure Complete")
                        {
                           $tl_class = "timeline-icon-cs";
...
logMsg("Desc: $tl_desc Date: $tl_date Type: $tl_type Image: $tl_imgfile Icon: $tl_iconfile Class: $tl_class",$logfile);
                  ?>                           
                     <tr>
                        ...
                        <td width="8%" class="icon_frame <?php echo $tl_class; ?>" style="background-color:#E4E4E4;broder-left:4px solid white;border-bottom:4px solid white">
                           <img src="../img/icons/<?php echo $tl_imgfile; ?>" alt="img" class="align-middle">
                        </td>
                        <td width="50%" class="timeline-item" style="background-color:#E4E4E4;border-bottom:4px solid white">
                             <span class="timeline-content right upper align-middle">
                                 <p class="show-for-small-only">date for mobile</p>
                                 <p><?php echo $tl_desc; if ($tl_desc=="Report Generated") echo "<br />$tl_link"; ?></p>
                             </span>
                        </td>
                        <td width="20%" style="background-color:#E4E4E4;border-bottom:4px solid white">
                           <?php echo $tl_date; ?>
                        </td>
                        <td width="10%" style="background-color:#E4E4E4;border-right:4px solid white;border-bottom:4px solid white">
                           <a href="patients.php?m&id=<?php echo $pe_id; ?>"><img src="../img/icons/greater.png" alt="greater than icon" class="align-right" /></a>
                        </td>
                     </tr>
                <?php } ?>
                </div>
...
<?php logMsg(">>>  ADD2 before select ", $logfile); ?>
               <div class="small-12 medium-12 large-12 cell">
...
<?php logMsg(">>>  ADD3 afer select ", $logfile); ?>
                        <div class="small-12 medium-12 large-12 cell">
                  <label>Address 1
...
<?php logMsg(">>>  ADD4 afer closing form tag ", $logfile); ?>
          </div>
        </div>
