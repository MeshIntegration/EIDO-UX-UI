...
logMsg(">>>> SESSION time_added set","wel.log");
}
...
logMsg(">>>> SESSION name set","wel.log");
}

//setting default
if(!$_order) {
logMsg(">>>> Set order to default","wel.log");
		    ...
		    <div class="medium-12 cell" style="min-height:40px;">
			    <div class="accordion clearfix" data-accordion data-allow-all-closed="true">
				    <div class="accordion-item" data-accordion-item>
					    <a href="#" class="accordion-title sort"></a><br />
<!-- START SORT PANEL -->
        ...
        <div style="padding-top: 0px !important;" class="small-12 medium-6 large-6 cell content-right <?php echo $managesurveys_hide; ?>">
          ...
          <div class="grid-x grid-padding-x">
			  ...
			  <hr />
               ...
               <div class="small-12 medium-12 large-12 cell">
                 <div class="grid-x">
                   <div class="small-3 medium-3 large-3 cell margin-vertical-2">
                       <select name="session_number" style="height: 40px !important; margin-top: -4px;">
                       ...
                       <div class="small-4 medium-4 large-4 cell">
                           ...
                           <div class="small-12 medium-6 large-8">
                                <span>
                                    <a href="procedures.php?m=msall&id=<?php echo $pe_id; ?>"><button class="button btn-pre" type="button" style="height: 39px !important; margin-top: 13px;"><strong style="color: white">Show All</strong></button></a>
                                </span>
                           </div>
                       </div>
  ...
  //             logMsg("procId: $pe_id - sessId: $sess_id - numOfSurveys: ".count($survey_ids), "wel.log");
      ...
      ?>
               ...
               <div class="small-12 medium-12 large-12 cell">
                 <div class="grid-x">
                       ...
                       <div class="small-4 medium-4 large-4 cell">
                           ...
                           <div class="small-12 medium-6 large-8">
                                <span>
                                    <a href="procedures.php?m=managesurveys&id=<?php echo $pe_id; ?>"><button class="button btn-pre" type="button" style="height: 39px !important; margin-top: 13px;"><strong style="color: white">Hide All</strong></button></a>
                                </span>
                           </div>
                       </div>
                            <!--<div class="small-12 medium-6 large-8 cell"></div>-->
        ...
        <?php $varname = "c_session".$s."Name"; ?>
            <div class="small-12 cell"><input type="text" name="<?php echo $varname; ?>" value="<?php echo $arr_proc_info[$s][$varname]; ?>" placeholder=""><br /></div>
        <?php 
               $varname = "c_prePost".$s;
         ...
         ?>
          ...
          ?>
            <div class="small-12 medium-12 large-12 cell" id="session_delay_time">
               ...
               <p><h5>Session Delay Time</h5>
               <input type="text" size="4" name="<?php echo $varname; ?>" value="<?php echo isset($arr_proc_info[$s][$varname]) ? $arr_proc_info[$s][$varname] : ''; ?>"><b: /></p>
            </div>
          <?php } ?>
            <div class="small-12 medium-12 large-12 cell">
