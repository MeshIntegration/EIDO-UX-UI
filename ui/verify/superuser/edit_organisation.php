    	  ...
    	  <div class="grid-x grid-padding-x">
			...
			<div class="small-12 medium-12 large-12 cell">
			  <div class="input-group">
                  ...
                  <input type="submit" class="button tiny" name="" value="Yes">
                </div>
				<div class="input-group-button default">
                  <input type="submit" class="button tiny inactive" name="" value="No">
                </div>
				<span class="input-group-label">Organisation has subdivisions?</span>
              </div>
            </div>
			<div class="small-12 medium-12 large-12 cell text-center">&nbsp;</div>
