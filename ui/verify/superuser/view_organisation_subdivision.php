...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h5>Organisation Overview<br /><span class="small">View and Edit an Organisation</span></h5>
	  <br>
      <h4>Insuracorp <span class="float-right active">active</span></h4>
	  <h5>Administrator Contact:</h5>
      <p>SBartholomew Jenkins</p>
	  <h5>Email Address:</h5>
      <p><a href="mailto:Bart@Insuracorp.com">Bart@Insuracorp.com</a></p>
	  <h5>Type:</h5>
	  <p>Hospital</p>
	  <img src="../img/insuracorp_logo.jpg" class="logo-thumb" />
	  <div class="small-12 medium-12 large-12 cell text-center md">
	    <a href="#" class="no-u"><p class="multi-directive">Manage Procedures<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle"></p></a>
		<a href="#" class="no-u"><p class="multi-directive">Manage Divisions<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle"></p></a>
      </div>
	  <div class="small-12 medium-12 large-12 cell text-center">
	    <input type="submit" name="" value="EDIT ORGANISATION" class="button large" />
	  </div>
	</div>
	<!-- End Content-Right -->
  </div>
