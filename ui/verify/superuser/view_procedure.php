  ...
  <div class="grid-x padding-x">
    ...
    <div class="cell navigation-bar">
	  <ul class="menu simple show-for-medium">
		...
		<li class="current"><a href="add_procedure.php">Procedures</a></li>
	  ...
	  <form>
    	  ...
    	  <div class="grid-x grid-padding-x">
        	  ...
        	  <label>Procedure Name
                <input type="text" name="" placeholder="Laparascopic Cholescstectomy">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>EIDO Procedure Code
                <input type="text" name="" placeholder="UG07">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell">
        	  <label>Display Name
                <input type="text" name="" placeholder="UG07 - Lap Choly NUH">
              </label>
            </div>
			<div class="small-12 medium-12 large-12 cell text-center">
			  <a href="#" class="no-u"><p class="directive">Manage Surveys<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle" /></p></a>
