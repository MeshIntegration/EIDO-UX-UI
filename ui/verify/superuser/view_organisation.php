...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <br>
      <h4>Nottingham Hospital <span class="float-right active">active</span></h4>
	  <h5>Administrator Contact:</h5>
      <p>Susan Johnson</p>
	  <h5>Email Address:</h5>
      <p><a href="mailto:Susan.Johnson@NottinghamHospital.com">Susan.Johnson@NottinghamHospital.com</a></p>
	  <h5>Type:</h5>
	  <p>Hospital</p>
	  <img src="../img/nottingham_logo.jpg" class="logo-thumb" />
	  <div class="small-12 medium-12 large-12 cell text-center">
	    <a href="#" class="no-u"><p class="directive">Manage Procedures<img src="../img/icons/greater.png" alt="greater than icon" class="float-right align-middle"></p></a>
      </div>
	  <div class="small-12 medium-12 large-12 cell text-center">
