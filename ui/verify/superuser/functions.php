...
else if ($mode=="delete_proc_survey")
{
   ...
   // updated delete survey - 4/1/18
   logMsg("Delete_proc_survey: Session before: ". $_SESSION['pe_id'.$pe_id]['sess_id'.$sess_id][$survey], $logfile);
   $_SESSION['pe_id'.$pe_id]['sess_id'.$sess_id] = array_diff($_SESSION['pe_id'.$pe_id]['sess_id'.$sess_id],array($survey));
   logMsg("Delete_proc_survey: Session after: ". $_SESSION['pe_id'.$pe_id]['sess_id'.$sess_id][$survey], $logfile); 
   // delete from temp 
