...
<div class="grid-container">
  ...
  <div class="grid-x grid-margin-x su" data-equalizer data-equalize-on="medium">
	...
	<div class="small-12 medium-6 large-6 cell content-right">
	  ...
	  <h2>Manage Customers<br /><span class="small">Add customers to your organisation</span></h2>
	  <hr />
	  <table width="100%" border="0"  class="">
  	    <tbody>
		  <tr>
			<td width="90%"><p class="name"><a href="#">Jeremy Renner</a><br /><span class="small"><a href="mailto:J.renner@surgeons.org.uk">J.renner@surgeons.org.uk</a></span></p></td>
			<td width="10%"><a href="#"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></a></td>
		  </tr>
		  <tr>
			<td width="90%"><p class="name"><a href="#">Sally Edmonds</a><br /><span class="small"><a href="mailto:S.edmonds@surgeons.org.uk">S.edmonds@surgeons.org.uk</a></span></p></td>
			<td width="10%"><a href="#"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></a></td>
		  </tr>
		  <tr>
			<td width="90%"><p class="name"><a href="#">Rav Mistry</a><br /><span class="small"><a href="mailto:Rav.Mistry2@surgeons.org.uk">Rav.Mistry2@surgeons.org.uk</a></span></p></td>
			<td width="10%"><a href="#"><img src="../img/icons/greater.png" alt="greater than icon" class="float-right" /></a></td>
		  </tr>
		  <tr>
			<td width="90%"><p class="name"><a href="#">Jeremy Renner</a><br /><span class="small"><a href="mailto:J.renner@surgeons.org.uk">J.renner@surgeons.org.uk</a></span></p></td>
		  ...
		  <tr>
		    <td colspan="2" class="text-center">
			  <hr>
			  <input type="submit" name="" value="Add New Customer" class="button large" />
			</td>
		  </tr>
  	    </tbody>
      </table>	
